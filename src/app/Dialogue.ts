...
export var chatbotMessages: any = {
  "greeting": {
    "start": [
      new dialogueTurn("bot", "Hey! Let me search for a laptop for you :)"),
      new dialogueTurn("bot", "I just have a few questions first."),
    ],
  },
  "purpose": {
    "start": [
    ...
    "noKeyfacts": [
      ...
      [new dialogueTurn("bot","Many users do things like document editing, browsing, gaming, and so on.", true, "open", "purpose")
      ]
    ],
    "notImportant": [
      new dialogueTurn("bot","What I understand from your answer is that you do not have specific tasks.", false, "none", "purpose"),
  ...
  "price": {
    ...
    "noKeyfacts": [
      ...
      [new dialogueTurn("bot","Most laptops cost around 500", true, "open", "price"),
    ...
    "notImportant": [
      ...
      new dialogueTurn("bot","In that case, I am going to leave that open for now and make sure that the laptops meet the other requirements. Is that fine with you?", true, "yesno", "price"),
    ],
    "no": [
