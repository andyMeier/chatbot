...
export var chatbotMessages: any = {
  ...
  "price": {
    ...
    "unsure": [
      new DialogueTurn("bot","If you are unsure which price point is right for you, I recommend laptops between XXXRECMIN and XXXRECMAX pounds.", false, "none", "price"),
  ...
  "battery": {
    ...
    "unsure": [
      new DialogueTurn("bot","If you are unsure which battery life you need, I recommend anything over XXXRECMIN hours of battery life.", false, "none", "battery"),
  ...
  "storage": {
    ...
    "unsure": [
      new DialogueTurn("bot","If you are unsure what the correct storage size is, I can look for laptops with XXXRECMIN GB to XXXRECMAX TB.", false, "none", "storage"),
  ...
  "ram": {
    ...
    "unsure": [
      new DialogueTurn("bot","If you are unsure what the correct RAM size is, I can look for laptops with XXXRECMIN GB to XXXRECMAX GB of RAM.", false, "none", "ram"),
  ...
  "display": {
    ...
    "unsure": [
      new DialogueTurn("bot","If you are unsure what the correct display size is, I can look for laptops with XXXRECMIN to XXXRECMAX inches displays.", false, "none", "display"),
  ...
  "presentOffer": {
    "start": [
      new DialogueTurn("bot","I found a laptop that fits all your wishes! ", false, "none", "presentOffer"),
    ],
    "ram": [
      new DialogueTurn("bot","It has XXXRAM ram!\n", false, "none", "presentOffer"),
      new DialogueTurn("bot","It has XXXRAM ram, but vogue!\n", false, "none", "presentOffer"),
    ],
    "storage": [
      new DialogueTurn("bot","It has also XXXSTORAGE of storage!\n", false, "none", "presentOffer"),
      new DialogueTurn("bot","It has also XXXSTORAGE of storage, but vogue!\n", false, "none", "presentOffer"),
    ]
    ,
    "size": [
      new DialogueTurn("bot","It the screen has a size of XXXSIZE!\n", false, "none", "presentOffer"),
      new DialogueTurn("bot","It the screen has a size of XXXSIZE, but vogue!\n", false, "none", "presentOffer"),
    ],
    "battery": [
      new DialogueTurn("bot","it has a battery life of XXXBATTERY!\n", false, "none", "presentOffer"),
      new DialogueTurn("bot","it has a battery life of XXXBATTERY, but vogue!\n", false, "none", "presentOffer"),
    ],
    "price": [
      new DialogueTurn("bot","And it only consts XXXPRICE pounds!\n", false, "none", "presentOffer"),
      new DialogueTurn("bot","And it only consts XXXPRICE pounds, but vogue!\n", false, "none", "presentOffer"),
    ],
    "end": [
